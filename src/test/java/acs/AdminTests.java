...
//				null, new Date(),
	...
	public void checkDeleteAllElements() throws Exception {
		...
		ElementBoundary output = this.restTemplate.postForObject(this.url + CREATE_ELEMENT, input,
				ElementBoundary.class, "managerTestDomain", "tomer32@gmail.com");
		...
		ElementBoundary[] result = this.restTemplate.getForObject(this.url + GET_ALL_ELEMENTS_OF_USER,
				ElementBoundary[].class, "userDomain", "tomer32@gmail.com");
	...
	public void checkExportAllUsers() throws Exception {
		...
		assertThat(result[0]).usingRecursiveComparison().isEqualTo(user);
	...
	public void checkExportAllActions() throws Exception {
		...
		ActionBoundary action = (ActionBoundary) this.restTemplate.postForObject(this.url + CREATE_ACTION, actionInput,
				ActionBoundary.class);
	...
	@Test
	public void checkExportAllWithPagination() throws Exception {
